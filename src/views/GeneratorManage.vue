                        ...
                        <el-form :inline="true" size="small">
                            ...
                            <el-form-item style="width: 120px;">
                                <el-select v-model="searchRequest.status" placeholder="状态">
                                    <el-option value="">全部</el-option>
                                    <el-option v-for="item in Constant.GeneratorStatusEnum" :key="item.id" :value="item.value" :label="item.label"></el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item>
                    ...
                    <el-col :span="24">
                        <el-card shadow="hover">
                            <div slot="header" class="card-header-flex">
                                <el-breadcrumb>
                                    <el-breadcrumb-item><strong @click="linkToGeneratorDetail(item)">{{item.name}}</strong></el-breadcrumb-item>
                                </el-breadcrumb>
                                <div>
                                    <el-button-group>
