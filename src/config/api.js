...
export default Vue.prototype.Api = {
    User:{
        ...
        signUpValidCodeSend: doPost('/user/signUpValidCodeSend'),
        infoGet: doPost('/user/infoGet'),
        get: doPost('/user/get'),
        passwordChange: doPost('/user/passwordChange'),
        profileChange: doPost('/user/profileChange'),
        passwordResetValidCodeSend: doPost('/user/passwordResetValidCodeSend'),
        passwordReset: doPost('/user/passwordReset'),
    },
    Generator: {
